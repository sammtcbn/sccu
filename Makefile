...
ALL_SAMPLE_BIN=ex01_localtime_get ex02_getch ex03_str_reverse ex04_get_module_path ex05_hostname_get ex06_str_random ex07_str_combine_path_file ex08_str_array ex09_str_split_to_array ex10_is_process_running ex11_uptime_get ex12_process_launch ex13_write_buffer_to_file ex14_read_file_to_buffer ex15_remove_file ex16_folder_create ex18_file_mode_as_public_read
...
ex18_file_mode_as_public_read: ex18_file_mode_as_public_read.o sccu.o
	$(CC) $(LDFLAGS) -o $@ $^
ex18_file_mode_as_public_read.o: ex18_file_mode_as_public_read.c
	$(CC) $(CFLAGS) -c $<
